...
<header class='header' id='js-header'>
  <div class='header-outer'>
    <div class='header-inner'>
      <div class="header-inner_before js-firstInView <?php echo $headerClass; ?>"></div>
      <div class="header-inner_after js-firstInView <?php echo $headerClass; ?>"></div>
      <div class="header-border"></div>
    <?php if (is_front_page()) : ?>
      <div class='header-logoWrap'>
        <h1 class='header-logo'>
          <span class="header-logo_inner js-firstInView <?php echo $headerClass; ?>">
      ...
      <div class='header-content' id="js-headerNav">
        <nav class='header-nav'>
          <ul class='header-nav_list'>
            <li class='header-nav_item js-firstInView <?php echo $headerClass; ?>'>
              <?php if (is_front_page()) : ?>
