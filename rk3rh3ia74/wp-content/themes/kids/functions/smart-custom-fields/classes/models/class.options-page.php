 ...
 */
class Theme_Smart_Custom_Fields_Options_Page {
	...
	public function display() {
		$Option = Theme_SCF::generate_option_object( $_GET['page'] );
		if ( !$Option ) {
			return;
		}
		?>
		<div class="wrap">
			...
			<?php do_action( Theme_SCF_Config::PREFIX . 'custom-options-page', $Option ); ?>
		</div>
		<?php
	}
}
