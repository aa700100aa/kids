 ...
 */
class Theme_Smart_Custom_Fields_Field_Wysiwyg extends Theme_Smart_Custom_Fields_Field_Base {
	...
	public function after_wp_tiny_mce() {
		printf(
			...
			get_stylesheet_directory_uri(). '/functions/' . Theme_SCF_Config::NAME . '/js/editor-wysiwyg.js'
		);
	}
	...
	public function admin_footer() {
		...
		<div style="display:none;">
			<?php wp_editor( '', Theme_SCF_Config::PREFIX . 'wysiwyg-base' ); ?>
		</div>
		<?php
	}
