 ...
 */
class Theme_Smart_Custom_Fields_Controller_Taxonomy extends Theme_Smart_Custom_Fields_Controller_Base {
	...
	public function admin_enqueue_scripts( $hook ) {
		...
		wp_enqueue_style(
			Theme_SCF_Config::PREFIX . 'taxonomy',
			get_stylesheet_directory_uri(). '/functions/' . Theme_SCF_Config::NAME . '/css/taxonomy.css'
		);
	}
	...
	public function edit_form_fields( $term ) {
		$settings = Theme_SCF::get_settings( $term );
	...
	public function delete( $term_id, $term_taxonomy_id, $taxonomy, $deleted_term ) {
		$Meta = new Theme_Smart_Custom_Fields_Meta( $deleted_term );
		$Meta->delete();
	}
}
