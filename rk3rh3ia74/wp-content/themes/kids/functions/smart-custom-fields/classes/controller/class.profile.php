 ...
 */
class Theme_Smart_Custom_Fields_Controller_Profile extends Theme_Smart_Custom_Fields_Controller_Base {
	...
	public function admin_enqueue_scripts( $hook ) {
		...
		wp_enqueue_style(
			Theme_SCF_Config::PREFIX . 'profile',
			get_stylesheet_directory_uri(). '/functions/' . Theme_SCF_Config::NAME . '/css/profile.css'
		);
	}
	...
	public function user_profile( $user ) {
		...
		$settings = Theme_SCF::get_settings( $user );
