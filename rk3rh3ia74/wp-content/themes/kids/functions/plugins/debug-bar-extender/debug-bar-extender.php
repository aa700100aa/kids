...
class Debug_Bar_Extender {
	...
	public function add_design_parts() {
		wp_enqueue_style( 'debug-bar-extender', theme_plugins_url( "css/debug-bar-extender.css", __FILE__ ), array('debug-bar'), '20110302' );
		wp_enqueue_script( 'debug-bar-extender', theme_plugins_url( "js/debug-bar-extender.js", __FILE__ ), array('debug-bar'), '20110302', true );
	}
