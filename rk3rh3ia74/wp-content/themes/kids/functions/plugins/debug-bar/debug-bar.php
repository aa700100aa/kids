...
class Debug_Bar {
	...
	function init() {
        ...
        load_theme_textdomain( 'debug-bar', dirname( __FILE__ ).'/languages' );
	...
	function enqueue() {
		...
		wp_enqueue_style( 'debug-bar', theme_plugins_url( "css/debug-bar$suffix.css", __FILE__ ), array(), '20170515' );

		wp_enqueue_script( 'debug-bar', theme_plugins_url( "js/debug-bar$suffix.js", __FILE__ ), array( 'jquery' ), '20170515', true );
