		...
		<tr valign="top">
			...
			<?php
				...
				foreach ( $post_types  as $post_type ) {
					if ( $post_type->name == 'attachment' || $post_type->name == 'staffs') continue;
					?>
		...
		<tr valign="top">
			...
			<?php
				...
				foreach( $taxonomies as $taxonomy ) {
					if ( $taxonomy->name == 'post_format' || $taxonomy->name == 'staffs_type' || $taxonomy->name == 'staffs_option' || $taxonomy->name == 'link_category') continue;
					?>
