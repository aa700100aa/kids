...
define( 'HICPO_URL', theme_plugins_url( '', __FILE__ ) );
...
class Hicpo
{
    function __construct()
    {
        ...
        add_action( 'after_setup_theme', array( $this, 'my_plugin_load_plugin_textdomain' ) );
        ...
        add_action( 'admin_print_scripts', array( $this, 'load_script_css' ) );
    ...
    function my_plugin_load_plugin_textdomain()
    {
        ...
        load_theme_textdomain( 'intuitive-custom-post-order', dirname( __FILE__ ).'/languages' );
    }
    function admin_menu()
    {
    ...
    function load_script_css()
    {
        if ( $this->_check_load_script_css() ) {
            ...
            //test($current_screen);
            wp_localize_script( 'hicpojs', '$themedata ',array('post_type'=>$current_screen->post_type));
    ...
    */
    ...
    function get_hicpo_options_objects()
    {
        ...
        /* 2017-04-12 adachi追加 */
        if(empty($objects)) { // if page or custom post types
            $objects = array('staffs');
        }elseif(!in_array('staffs',$objects)){
            $objects[] = 'staffs';
        }
        /* /2017-04-12 adachi追加 */
    ...
    function get_hicpo_options_tags()
    {
        ...
        /* 2017-04-12 adachi追加 */
        if(empty($tags)) {
            $tags = array('staffs_type','staffs_option');
        }elseif(!in_array('staffs_type',$tags) || !in_array('staffs_option',$tags)){
            if(!in_array('staffs_type',$tags))$tags[] = 'staffs_type';
            if(!in_array('staffs_option',$tags))$tags[] = 'staffs_option';
        }
        /* /2017-04-12 adachi追加 */
